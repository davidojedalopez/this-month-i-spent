      ...
      >
        ...
        <div v-if="transactionsByDay[day]" class="flex-container">
          ...
          <div v-if="transactionsByDay[day].income > 0" class="tooltip">
            <svg fill="rgb(0, 124, 0)" :width="iconSize(transactionsByDay[day].income)" :height="iconSize(transactionsByDay[day].income)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          ...
          <div v-if="Math.abs(transactionsByDay[day].spending) > 0" class="tooltip">
            <svg fill="rgb(180, 0, 0)" :width="iconSize(Math.abs(transactionsByDay[day].spending))" :height="iconSize(Math.abs(transactionsByDay[day].spending))" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
